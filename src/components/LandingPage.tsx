          ...
          <div className="relative z-10 max-w-lg">
            ...
            >
              ...
              <div className="h-[68px] flex items-end px-4 pb-2.5 relative"
                ...
                <span className="text-[9px] font-bold uppercase tracking-widest text-white/75">SocialBuzz Summit 2025 · Mumbai</span>
        ...
        <div className="lg:w-[45%] flex flex-col items-center justify-center bg-white px-8 py-16 lg:px-14">
          <div className="w-full max-w-[340px]">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mb-8">
              Sign in with your Google account to manage events and templates.
            </p>
