...
var vs = I((Et) => {
  ...
  var D = Yr(), sc = bs(), nn = 1, oc = 4, Ss = nn + oc, xs = y.allocUnsafe(0), on = class on {
    constructor(e) {
      if (this.buffer = xs, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new sc.BufferReader(), (e == null ? void 0 : e.mode) === "binary") throw new Error("Binary mode not supported yet");
...
var _n = class _n2 extends Tt.Pool {
  ...
  query(t, n, i) {
    ...
    try {
      ...
      Ys(h, { fullResults: true, arrayMode: t.rowMode === "array" })(l, d, { types: t.types ?? ((_a = this.options) == null ? void 0 : _a.types) }).then((C) => i(void 0, C)).catch((C) => i(
        C
      ));
    } catch (o) {
      i(o);
...
var VercelPool = class extends Zs {
  ...
  async sql(strings, ...values) {
    const [query, params] = sqlTemplate(strings, ...values);
    const sql2 = Ys(this.connectionString, {
      fullResults: true
    });
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=@vercel_postgres.js.map
